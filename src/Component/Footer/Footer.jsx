...
const Footer = () => {
    return (
        <footer className="px-4 lg:px-12 divide-y bg-blue-800 text-white
		 ">
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
				<div className="flex items-center justify-center w-12 h-12 rounded-full dark:bg-violet-600">
					<img src="https://i.ibb.co/4wfphrmK/logo-2.jpg" className='rounded-full' alt="" />
				</div>
				<span className="self-center text-2xl font-semibold">EMS</span>
			</a>
		</div>
	...
	<div className="py-6 text-sm text-center">© EMS All rights reserved.</div>
</footer>
    );
};
