...
const EmployeeList = () => {
  ...
  return (
    <div className="overflow-x-auto rounded-lg shadow-md mt-5 bg-white dark:bg-gray-900 p-6 max-w-7xl mx-auto">
      <h2 className="text-3xl font-bold poppins-regular text-center mb-6 text-gray-900 dark:text-white">
        Employee List
      </h2>
      ...
      <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
        <thead className="bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300">
          <tr>
            <th className="px-6 py-3 text-left text-sm font-semibold uppercase tracking-wider poppins-regular">Name</th>
            <th className="px-6 py-3 text-left text-sm font-semibold uppercase tracking-wider poppins-regular">Email</th>
            <th className="px-6 py-3 text-center text-sm font-semibold uppercase tracking-wider poppins-regular">Verified</th>
            <th className="px-6 py-3 text-center text-sm font-semibold uppercase tracking-wider poppins-regular">Bank Account</th>
            <th className="px-6 py-3 text-center text-sm font-semibold uppercase tracking-wider poppins-regular">Salary</th>
            <th className="px-6 py-3 text-center text-sm font-semibold uppercase tracking-wider poppins-regular">Pay</th>
            <th className="px-6 py-3 text-center text-sm font-semibold uppercase tracking-wider poppins-regular">Details</th>
          </tr>
        </thead>
          ...
          {users.length === 0 ? (
            ...
            users.map((user) => (
              <tr key={user._id} className="hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors duration-200">
                <td className="px-6 py-4 whitespace-nowrap inter">{user.name}</td>
                <td className="px-6 py-4 whitespace-nowrap inter">{user.email}</td>
