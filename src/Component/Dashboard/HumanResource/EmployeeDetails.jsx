...
const EmployeeDetails = () => {
  ...
  if (!employee) return <p className="text-center py-10 text-red-500">Employee not found!</p>;
  ...
  return (
    <div className="p-6">
      ...
      {/* Employee Info */}
      <div className="flex flex-col md:flex-row items-center gap-6 mb-10 bg-white p-4 rounded-lg shadow">
        <img
      ...
      {salaryData?.length > 0 ? (
        <div style={{ width: '100%', height: 400 }} className="bg-white p-4 rounded-lg shadow">
